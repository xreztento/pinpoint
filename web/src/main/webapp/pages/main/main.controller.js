(function($) {
     ...
     * @class
     */
    pinpointApp.controller( "MainCtrl", [ "filterConfig", "$scope", "$rootScope", "$location", "$timeout", "$routeParams", "locationService", "UrlVoService", "NavbarVoService", "$window", "SidebarTitleVoService", "filteredMapUtilService", "$rootElement", "AnalyticsService", "PreferenceService", "LogoutAjaxService",
        function (cfg, $scope, $rootScope, $location, $timeout, $routeParams, locationService, UrlVoService, NavbarVoService, $window, SidebarTitleVoService, filteredMapUtilService, $rootElement, analyticsService, preferenceService, LogoutAjaxService) {
            ...
            /**
             * rootScope event on myself.show
             */
            $scope.$on('myself.show', function () {
                $("#newpassword-btn").click(function(){
                    $("#newpassword-modal").modal("show");
                });
                $("#logout-btn").click(function(){
                    LogoutAjaxService.logout();
                    $rootScope.userSession.clear();
