            ...
            return {
                ...
                link: function (scope, element) {
                    ...
                    $("[data-toggle='popover']").popover({html : true ,
                        template : '<div style="right:200px;" class="popover" role="tooltip"><ul style="display:block;" class="popover-content dropdown-menu"></ul></div>'});

                    $("[data-toggle='popover']").on('shown.bs.popover', function () {
                        $rootScope.$broadcast("myself.show");
                    });
