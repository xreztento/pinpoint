...
import com.navercorp.pinpoint.plugin.apusic.*;
 ...
 */
public class WebContainerDoProcessRequestInterceptor implements AroundInterceptor1 {
    ...
    public WebContainerDoProcessRequestInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
        this.traceContext = traceContext;
        this.methodDescriptor = descriptor;

        ApusicConfig apusicConfig = new ApusicConfig(traceContext.getProfilerConfig());
        this.excludeUrlFilter = apusicConfig.getApusicExcludeUrlFilter();

        final String proxyIpHeader = apusicConfig.getApusicRealIpHeader();
        if (proxyIpHeader == null || proxyIpHeader.isEmpty()) {
            this.remoteAddressResolver = new Bypass<HttpServletRequest>();
        } else {
            final String ApusicRealIpEmptyValue = apusicConfig.getApusicRealIpEmptyValue();
            this.remoteAddressResolver = new RealIpHeaderResolver<HttpServletRequest>(proxyIpHeader, ApusicRealIpEmptyValue);
        }
        this.isTraceRequestParam = apusicConfig.isApusicTraceRequestParam();
        this.excludeProfileMethodFilter = apusicConfig.getApusicExcludeProfileMethodFilter();
    ...
    public void before(Object target, Object arg0) {
        ...
        try {
            final Trace trace = createTrace(target, arg0);
            if (trace == null) {
                return;
            }
    ...
    public void after(Object target, Object arg0, Object result, Throwable throwable) {
        ...
        try {
            ...
            if (this.isTraceRequestParam) {
                final HttpProtocol httpProtocol = (HttpProtocol)arg0;
                final HttpServletRequest request = (HttpServletRequest) httpProtocol.request;
            ...
            traceContext.removeTraceObject();
            deleteTrace(trace, target, arg0, result, throwable);
        }
    }
    ...
    private Trace createTrace(Object target, Object arg0) {
    ...
    private void recordRootSpan(final SpanRecorder recorder, final HttpServletRequest request) {
        // root
        recorder.recordServiceType(ApusicConstants.APUSIC);
    ...
    private void deleteTrace(Trace trace, Object target, Object arg0, Object result, Throwable throwable) {
        trace.traceBlockEnd();
        final HttpProtocol httpProtocol = (HttpProtocol)arg0;
        final HttpServletRequest request = (HttpServletRequest) httpProtocol.request;
        if (!isAsynchronousProcess(request)) {
