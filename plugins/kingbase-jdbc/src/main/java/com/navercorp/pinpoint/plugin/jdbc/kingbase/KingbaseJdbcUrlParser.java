 ...
 * @author Brad Hong
 */
public class KingbaseJdbcUrlParser implements JdbcUrlParserV2 {

    private static final String URL_PREFIX = "jdbc:kingbase:";
    // jdbc:kingbase:loadbalance://10.22.33.44:3306,10.22.33.55:3306/Kingbase?characterEncoding=UTF-8
    ...
    public DatabaseInfo parse(String jdbcUrl) {
        ...
        try {
            ...
            logger.info("KingbaseJdbcUrl parse error. url: {}, Caused: {}", jdbcUrl, e.getMessage(), e);
            result = UnKnownDatabaseInfo.createUnknownDataBase(KingbaseConstants.KINGBASE, KingbaseConstants.KINGBASE_EXECUTE_QUERY, jdbcUrl);
        }
        return result;
    }
    ...
    private DatabaseInfo parseLoadbalancedUrl(String url) {
        // jdbc:kingbase://1.2.3.4:5678/test_db
        ...
        return new DefaultDatabaseInfo(KingbaseConstants.KINGBASE, KingbaseConstants.KINGBASE_EXECUTE_QUERY, url, normalizedUrl, hostList, databaseId);
    }
    ...
    public ServiceType getServiceType() {
        return KingbaseConstants.KINGBASE;
    }
