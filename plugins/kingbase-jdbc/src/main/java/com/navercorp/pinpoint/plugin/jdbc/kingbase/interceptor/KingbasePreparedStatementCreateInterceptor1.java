...
public class KingbasePreparedStatementCreateInterceptor1 extends SpanEventSimpleAroundInterceptorForPlugin {

    public KingbasePreparedStatementCreateInterceptor1(TraceContext context, MethodDescriptor descriptor) {
