...
public final class KingbaseConstants {
    ...
    public static final ServiceType KINGBASE_EXECUTE_QUERY = ServiceTypeFactory.of(2191, "KINGBASE_EXECUTE_QUERY", "POSTGRESQL", TERMINAL, RECORD_STATISTICS, INCLUDE_DESTINATION_ID);
}
