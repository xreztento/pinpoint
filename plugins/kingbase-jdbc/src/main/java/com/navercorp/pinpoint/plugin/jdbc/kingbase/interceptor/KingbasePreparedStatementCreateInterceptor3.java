...
public class KingbasePreparedStatementCreateInterceptor3 extends SpanEventSimpleAroundInterceptorForPlugin {

    public KingbasePreparedStatementCreateInterceptor3(TraceContext context, MethodDescriptor descriptor) {
