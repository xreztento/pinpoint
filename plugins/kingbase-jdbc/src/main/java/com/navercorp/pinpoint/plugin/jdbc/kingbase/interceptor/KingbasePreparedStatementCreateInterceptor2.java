...
public class KingbasePreparedStatementCreateInterceptor2 extends SpanEventSimpleAroundInterceptorForPlugin {

    public KingbasePreparedStatementCreateInterceptor2(TraceContext context, MethodDescriptor descriptor) {
