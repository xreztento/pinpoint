 ...
 */
public class OscarJdbcUrlParser implements JdbcUrlParserV2 {

    private static final String URL_PREFIX = "jdbc:oscar:";
    // jdbc:oscar:loadbalance://10.22.33.44:3306,10.22.33.55:3306/MySQL?characterEncoding=UTF-8
    ...
    public DatabaseInfo parse(String jdbcUrl) {
        ...
        try {
            ...
            logger.info("OscarJdbcUrl parse error. url: {}, Caused: {}", jdbcUrl, e.getMessage(), e);
            result = UnKnownDatabaseInfo.createUnknownDataBase(OscarConstants.OSCAR, OscarConstants.OSCAR_EXECUTE_QUERY, jdbcUrl);
        }
        return result;
    }
    ...
    private DatabaseInfo parseLoadbalancedUrl(String jdbcUrl) {
        // jdbc:oscar://1.2.3.4:5678/test_db
        ...
        return new DefaultDatabaseInfo(OscarConstants.OSCAR, OscarConstants.OSCAR_EXECUTE_QUERY, jdbcUrl, normalizedUrl, hostList, databaseId);
    }
